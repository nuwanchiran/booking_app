...
export default function GiveTips({ navigation }) {
    ...
    <Screen navigation={navigation} title="Travel Community" goBack>
      ...
      <ScrollView>
        <View style={styles.card}>
          ...
          >
            <FontAwesome name="diamond" size={24} color="darkblue" />
            <Text style={styles.header}>Give a Tip</Text>
          </View>
          <View style={styles.formContainer}>
            ...
            <Text style={{ paddingTop: 15 }}>
              Your tip <Text style={styles.star}>*</Text>
            </Text>
            <View
              style={{ borderWidth: 1, borderColor: "black", borderRadius: 4 }}
            >
